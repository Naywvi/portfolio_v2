...
export const metadata = {
  ...
  description: 'Développeur Full Stack spécialisé en React, Next.js, Node.js. Découvrez mes projets et compétences en développement web moderne.',
  keywords: 'développeur, full stack, react, nextjs, nodejs, portfolio, nagib lakhdari',
  authors: [{ name: 'Nagib Lakhdari' }],
  creator: 'Nagib Lakhdari',
  openGraph: {
    title: 'Nagib Lakhdari - Développeur Full Stack',
    description: 'Portfolio de développeur Full Stack - Projets en React, Next.js, Node.js',
